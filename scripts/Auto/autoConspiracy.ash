...
// Gore Bucket quest
string goreOutfit			= "coinLab";
string goreAutoAttack		= "coinLab";
string goreFamiliar			= "Angry Jung Man";
string goreMood				= "";

// Military-grade Fingernail Clippers quest
string clippingOutfit		= "WeirdKill";
string clippingAutoAttack	= "WeirdKill";
string clippingFamiliar		= "Temporal Riftlet";
string clippingMood			= "";

// Puns quest
string punsOutfit			= "coinJungle";
string punsAutoAttack		= "Beach";
string punsFamiliar			= "Stocking Mimic";
string punsMood				= "";
